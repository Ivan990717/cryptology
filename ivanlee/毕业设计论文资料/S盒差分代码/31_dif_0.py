...
def regular_encode(message,key):
    ...
    #key_bin2 = gen_key(key, 31)  # 产生每一轮的密钥
    key_f = key[0:32]
    print("使用的32位密钥为：", key_f,len(key_f))
...
if __name__ == '__main__':
    plain = "1010110101100100011110101110011110100100101100010111000100100110"
    key ="00000011011000110110000010110000010000010101010010110111000101010110110010001001"
