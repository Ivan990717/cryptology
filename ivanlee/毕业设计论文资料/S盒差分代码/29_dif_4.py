...
def regular_encode(message,key):
    ...
    print("原明文a为：",hexhex(left_plain[12:16]))
...
def difference_encode(message,key):
    ...
    f = str_xor(guzhang, message[12:16])
    left_plain=message[:12]+f+message[16:32]
    right_plain=message[32:]
...
if __name__ == '__main__':
    plain = "1000011110011001110010011010111110000001110111000011100001011010"
    key = "00101100111000000101010100101000000001010101101100100010010100101101100011011000"
